...
ALTER TABLE student ADD CONSTRAINT student_chk_age CHECK( (year(getdate()) - year(dob)) BETWEEN 18 AND 35);
ALTER TABLE lecturer ADD CONSTRAINT lecturer_chk_age CHECK( (year(getdate()) - year(dob)) BETWEEN 22 AND 65);
